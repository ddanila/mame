...
static INPUT_PORTS_START(datarover840)
	...
	PORT_START("TOUCH_X")
	PORT_BIT(0xffff, 0x8000, IPT_LIGHTGUN_X) PORT_NAME("Pen X") PORT_MINMAX(0, 0xffff) PORT_SENSITIVITY(100) PORT_KEYDELTA(256) PORT_CROSSHAIR(X, 1.0, 0.0, 0)

	PORT_START("TOUCH_Y")
	PORT_BIT(0xffff, 0x8000, IPT_LIGHTGUN_Y) PORT_NAME("Pen Y") PORT_MINMAX(0, 0xffff) PORT_SENSITIVITY(100) PORT_KEYDELTA(256) PORT_CROSSHAIR(Y, 1.0, 0.0, 0)
